...
const (
	Query_OsmosisArithmeticTwap_FullMethodName = "/feeabstraction.feeabs.v1beta1.Query/OsmosisArithmeticTwap"
	Query_FeeabsModuleBalances_FullMethodName  = "/feeabstraction.feeabs.v1beta1.Query/FeeabsModuleBalances"
	Query_HostChainConfig_FullMethodName       = "/feeabstraction.feeabs.v1beta1.Query/HostChainConfig"
	Query_AllHostChainConfig_FullMethodName    = "/feeabstraction.feeabs.v1beta1.Query/AllHostChainConfig"
)
