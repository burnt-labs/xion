...
func init() {
	file_xion_mint_v1_query_proto_init()
	md_QueryParamsRequest = File_xion_mint_v1_query_proto.Messages().ByName("QueryParamsRequest")
}
...
func (x *QueryParamsRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_mint_v1_query_proto_msgTypes[0]
...
func (x *fastReflection_QueryParamsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryParamsRequest"))
		}
		panic(fmt.Errorf("message xion.mint.v1.QueryParamsRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryParamsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message xion.mint.v1.QueryParamsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryParamsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.mint.v1.QueryParamsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_xion_mint_v1_query_proto_init()
	md_QueryParamsResponse = File_xion_mint_v1_query_proto.Messages().ByName("QueryParamsResponse")
...
func (x *QueryParamsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_mint_v1_query_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryParamsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "xion.mint.v1.QueryParamsResponse.params":
		return x.Params != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryParamsResponse"))
		}
		panic(fmt.Errorf("message xion.mint.v1.QueryParamsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryParamsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message xion.mint.v1.QueryParamsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryParamsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.mint.v1.QueryParamsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_xion_mint_v1_query_proto_init()
	md_QueryInflationRequest = File_xion_mint_v1_query_proto.Messages().ByName("QueryInflationRequest")
}
...
func (x *QueryInflationRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_mint_v1_query_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryInflationRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryInflationRequest"))
		}
		panic(fmt.Errorf("message xion.mint.v1.QueryInflationRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryInflationRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message xion.mint.v1.QueryInflationRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryInflationRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.mint.v1.QueryInflationRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_xion_mint_v1_query_proto_init()
	md_QueryInflationResponse = File_xion_mint_v1_query_proto.Messages().ByName("QueryInflationResponse")
...
func (x *QueryInflationResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_mint_v1_query_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryInflationResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "xion.mint.v1.QueryInflationResponse.inflation":
		return len(x.Inflation) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryInflationResponse"))
		}
		panic(fmt.Errorf("message xion.mint.v1.QueryInflationResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryInflationResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message xion.mint.v1.QueryInflationResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryInflationResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "xion.mint.v1.QueryInflationResponse.inflation":
		panic(fmt.Errorf("field inflation of message xion.mint.v1.QueryInflationResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryInflationResponse"))
		}
...
func (x *fastReflection_QueryInflationResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.mint.v1.QueryInflationResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_xion_mint_v1_query_proto_init()
	md_QueryAnnualProvisionsRequest = File_xion_mint_v1_query_proto.Messages().ByName("QueryAnnualProvisionsRequest")
}
...
func (x *QueryAnnualProvisionsRequest) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_mint_v1_query_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryAnnualProvisionsRequest) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryAnnualProvisionsRequest"))
		}
		panic(fmt.Errorf("message xion.mint.v1.QueryAnnualProvisionsRequest does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryAnnualProvisionsRequest) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message xion.mint.v1.QueryAnnualProvisionsRequest does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryAnnualProvisionsRequest) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.mint.v1.QueryAnnualProvisionsRequest", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_xion_mint_v1_query_proto_init()
	md_QueryAnnualProvisionsResponse = File_xion_mint_v1_query_proto.Messages().ByName("QueryAnnualProvisionsResponse")
...
func (x *QueryAnnualProvisionsResponse) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_mint_v1_query_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_QueryAnnualProvisionsResponse) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "xion.mint.v1.QueryAnnualProvisionsResponse.annual_provisions":
		return len(x.AnnualProvisions) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryAnnualProvisionsResponse"))
		}
		panic(fmt.Errorf("message xion.mint.v1.QueryAnnualProvisionsResponse does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_QueryAnnualProvisionsResponse) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message xion.mint.v1.QueryAnnualProvisionsResponse does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_QueryAnnualProvisionsResponse) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "xion.mint.v1.QueryAnnualProvisionsResponse.annual_provisions":
		panic(fmt.Errorf("field annual_provisions of message xion.mint.v1.QueryAnnualProvisionsResponse is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: xion.mint.v1.QueryAnnualProvisionsResponse"))
		}
...
func (x *fastReflection_QueryAnnualProvisionsResponse) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.mint.v1.QueryAnnualProvisionsResponse", d.FullName()))
	}
	panic("unreachable")
}
...
func (*QueryParamsRequest) Descriptor() ([]byte, []int) {
	return file_xion_mint_v1_query_proto_rawDescGZIP(), []int{0}
}
...
func (*QueryParamsResponse) Descriptor() ([]byte, []int) {
	return file_xion_mint_v1_query_proto_rawDescGZIP(), []int{1}
}
...
func (*QueryInflationRequest) Descriptor() ([]byte, []int) {
	return file_xion_mint_v1_query_proto_rawDescGZIP(), []int{2}
}
...
func (*QueryInflationResponse) Descriptor() ([]byte, []int) {
	return file_xion_mint_v1_query_proto_rawDescGZIP(), []int{3}
}
...
func (*QueryAnnualProvisionsRequest) Descriptor() ([]byte, []int) {
	return file_xion_mint_v1_query_proto_rawDescGZIP(), []int{4}
}
...
func (*QueryAnnualProvisionsResponse) Descriptor() ([]byte, []int) {
	return file_xion_mint_v1_query_proto_rawDescGZIP(), []int{5}
}
...
var File_xion_mint_v1_query_proto protoreflect.FileDescriptor

var file_xion_mint_v1_query_proto_rawDesc = []byte{
	0x0a, 0x18, 0x78, 0x69, 0x6f, 0x6e, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x71,
	0x75, 0x65, 0x72, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0c, 0x78, 0x69, 0x6f, 0x6e,
	0x2e, 0x6d, 0x69, 0x6e, 0x74, 0x2e, 0x76, 0x31, 0x1a, 0x14, 0x67, 0x6f, 0x67, 0x6f, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x1c,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x61, 0x6e, 0x6e, 0x6f, 0x74,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x17, 0x78, 0x69,
	0x6f, 0x6e, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x2e,
	...
	,
	...
	,
	...
	0x2f, 0x6d, 0x69, 0x6e, 0x74, 0x2f, 0x76, 0x31, 0x3b, 0x6d, 0x69, 0x6e, 0x74, 0x76, 0x31, 0xa2,
	0x02, 0x03, 0x58, 0x4d, 0x58, 0xaa, 0x02, 0x0c, 0x58, 0x69, 0x6f, 0x6e, 0x2e, 0x4d, 0x69, 0x6e,
	0x74, 0x2e, 0x56, 0x31, 0xca, 0x02, 0x0c, 0x58, 0x69, 0x6f, 0x6e, 0x5c, 0x4d, 0x69, 0x6e, 0x74,
	0x5c, 0x56, 0x31, 0xe2, 0x02, 0x18, 0x58, 0x69, 0x6f, 0x6e, 0x5c, 0x4d, 0x69, 0x6e, 0x74, 0x5c,
	0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02,
	0x0e, 0x58, 0x69, 0x6f, 0x6e, 0x3a, 0x3a, 0x4d, 0x69, 0x6e, 0x74, 0x3a, 0x3a, 0x56, 0x31, 0x62,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_xion_mint_v1_query_proto_rawDescOnce sync.Once
	file_xion_mint_v1_query_proto_rawDescData = file_xion_mint_v1_query_proto_rawDesc
)

func file_xion_mint_v1_query_proto_rawDescGZIP() []byte {
	file_xion_mint_v1_query_proto_rawDescOnce.Do(func() {
		file_xion_mint_v1_query_proto_rawDescData = protoimpl.X.CompressGZIP(file_xion_mint_v1_query_proto_rawDescData)
	})
	return file_xion_mint_v1_query_proto_rawDescData
}

var file_xion_mint_v1_query_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_xion_mint_v1_query_proto_goTypes = []interface{}{
	(*QueryParamsRequest)(nil),            // 0: xion.mint.v1.QueryParamsRequest
	(*QueryParamsResponse)(nil),           // 1: xion.mint.v1.QueryParamsResponse
	(*QueryInflationRequest)(nil),         // 2: xion.mint.v1.QueryInflationRequest
	(*QueryInflationResponse)(nil),        // 3: xion.mint.v1.QueryInflationResponse
	(*QueryAnnualProvisionsRequest)(nil),  // 4: xion.mint.v1.QueryAnnualProvisionsRequest
	(*QueryAnnualProvisionsResponse)(nil), // 5: xion.mint.v1.QueryAnnualProvisionsResponse
	(*Params)(nil),                        // 6: xion.mint.v1.Params
}
var file_xion_mint_v1_query_proto_depIdxs = []int32{
	6, // 0: xion.mint.v1.QueryParamsResponse.params:type_name -> xion.mint.v1.Params
	0, // 1: xion.mint.v1.Query.Params:input_type -> xion.mint.v1.QueryParamsRequest
	2, // 2: xion.mint.v1.Query.Inflation:input_type -> xion.mint.v1.QueryInflationRequest
	4, // 3: xion.mint.v1.Query.AnnualProvisions:input_type -> xion.mint.v1.QueryAnnualProvisionsRequest
	1, // 4: xion.mint.v1.Query.Params:output_type -> xion.mint.v1.QueryParamsResponse
	3, // 5: xion.mint.v1.Query.Inflation:output_type -> xion.mint.v1.QueryInflationResponse
	5, // 6: xion.mint.v1.Query.AnnualProvisions:output_type -> xion.mint.v1.QueryAnnualProvisionsResponse
...
func init() { file_xion_mint_v1_query_proto_init() }
func file_xion_mint_v1_query_proto_init() {
	if File_xion_mint_v1_query_proto != nil {
		return
	}
	file_xion_mint_v1_mint_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_xion_mint_v1_query_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_xion_mint_v1_query_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_xion_mint_v1_query_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_xion_mint_v1_query_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_xion_mint_v1_query_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_xion_mint_v1_query_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_xion_mint_v1_query_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_xion_mint_v1_query_proto_goTypes,
		DependencyIndexes: file_xion_mint_v1_query_proto_depIdxs,
		MessageInfos:      file_xion_mint_v1_query_proto_msgTypes,
	}.Build()
	File_xion_mint_v1_query_proto = out.File
	file_xion_mint_v1_query_proto_rawDesc = nil
	file_xion_mint_v1_query_proto_goTypes = nil
	file_xion_mint_v1_query_proto_depIdxs = nil
}
