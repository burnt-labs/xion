...
func init() {
	...
	md_Params = File_xion_zk_v1_params_proto.Messages().ByName("Params")
...
func (x *Params) slowProtoReflect() protoreflect.Message {
	mi := &file_xion_zk_v1_params_proto_msgTypes[0]
...
func (x *fastReflection_Params) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if x.MaxVkeySizeBytes != uint64(0) {
		value := protoreflect.ValueOfUint64(x.MaxVkeySizeBytes)
		if !f(fd_Params_max_vkey_size_bytes, value) {
			return
		}
	}
	if x.UploadChunkSize != uint64(0) {
		value := protoreflect.ValueOfUint64(x.UploadChunkSize)
		if !f(fd_Params_upload_chunk_size, value) {
			return
		}
	}
	if x.UploadChunkGas != uint64(0) {
		value := protoreflect.ValueOfUint64(x.UploadChunkGas)
		if !f(fd_Params_upload_chunk_gas, value) {
			return
		}
	}
...
func (x *fastReflection_Params) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "xion.zk.v1.Params.max_vkey_size_bytes":
		return x.MaxVkeySizeBytes != uint64(0)
	...
	default:
		...
		panic(fmt.Errorf("message xion.zk.v1.Params does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Params) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "xion.zk.v1.Params.max_vkey_size_bytes":
		value := x.MaxVkeySizeBytes
		return protoreflect.ValueOfUint64(value)
	case "xion.zk.v1.Params.upload_chunk_size":
		value := x.UploadChunkSize
		return protoreflect.ValueOfUint64(value)
	case "xion.zk.v1.Params.upload_chunk_gas":
	...
	default:
		...
		panic(fmt.Errorf("message xion.zk.v1.Params does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Params) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "xion.zk.v1.Params.max_vkey_size_bytes":
		panic(fmt.Errorf("field max_vkey_size_bytes of message xion.zk.v1.Params is not mutable"))
	case "xion.zk.v1.Params.upload_chunk_size":
...
func (x *fastReflection_Params) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in xion.zk.v1.Params", d.FullName()))
	}
	panic("unreachable")
}
...
func (x *fastReflection_Params) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		...
		var l int
		_ = l
		if x.MaxVkeySizeBytes != 0 {
			n += 1 + runtime.Sov(uint64(x.MaxVkeySizeBytes))
		}
		if x.UploadChunkSize != 0 {
			n += 1 + runtime.Sov(uint64(x.UploadChunkSize))
		}
	...
	marshal := func(input protoiface.MarshalInput) (protoiface.MarshalOutput, error) {
		...
		if x.UploadChunkSize != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.UploadChunkSize))
			i--
			dAtA[i] = 0x10
		}
		if x.MaxVkeySizeBytes != 0 {
			i = runtime.EncodeVarint(dAtA, i, uint64(x.MaxVkeySizeBytes))
			i--
			dAtA[i] = 0x8
		}
		if input.Buf != nil {
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			case 1:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field MaxVkeySizeBytes", wireType)
				}
				x.MaxVkeySizeBytes = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, runtime.ErrIntOverflow
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.MaxVkeySizeBytes |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 2:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UploadChunkSize", wireType)
				}
				x.UploadChunkSize = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.UploadChunkSize |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
			case 3:
				if wireType != 0 {
					return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: wrong wireType = %d for field UploadChunkGas", wireType)
				}
				x.UploadChunkGas = 0
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
					...
					b := dAtA[iNdEx]
					iNdEx++
					x.UploadChunkGas |= uint64(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
...
func (x *Params) GetMaxVkeySizeBytes() uint64 {
	if x != nil {
		return x.MaxVkeySizeBytes
	}
	return 0
}

func (x *Params) GetUploadChunkSize() uint64 {
	if x != nil {
		return x.UploadChunkSize
	}
	return 0
}

func (x *Params) GetUploadChunkGas() uint64 {
	if x != nil {
		return x.UploadChunkGas
	}
	return 0
}
...
var file_xion_zk_v1_params_proto_rawDesc = []byte{
	0x0a, 0x17, 0x78, 0x69, 0x6f, 0x6e, 0x2f, 0x7a, 0x6b, 0x2f, 0x76, 0x31, 0x2f, 0x70, 0x61, 0x72,
	...
	0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xc9,
	0x03, 0x0a, 0x06, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x2d, 0x0a, 0x13, 0x6d, 0x61, 0x78,
	...
	0x61, 0x64, 0x5f, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x02, 0x20,
	...
	0x65, 0x73, 0x3a, 0x16, 0x98, 0xa0, 0x1f, 0x00, 0xe8, 0xa0, 0x1f, 0x01, 0x8a, 0xe7, 0xb0, 0x2a,
	0x09, 0x7a, 0x6b, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x2a, 0x65, 0x0a, 0x0b, 0x50, 0x72,
	0x6f, 0x6f, 0x66, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x12, 0x1c, 0x0a, 0x18, 0x50, 0x52, 0x4f,
	0x4f, 0x46, 0x5f, 0x53, 0x59, 0x53, 0x54, 0x45, 0x4d, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43,
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x18, 0x0a, 0x14, 0x50, 0x52, 0x4f, 0x4f, 0x46,
...
var (
	file_xion_zk_v1_params_proto_rawDescOnce sync.Once
	file_xion_zk_v1_params_proto_rawDescData = file_xion_zk_v1_params_proto_rawDesc
)

func file_xion_zk_v1_params_proto_rawDescGZIP() []byte {
	file_xion_zk_v1_params_proto_rawDescOnce.Do(func() {
		file_xion_zk_v1_params_proto_rawDescData = protoimpl.X.CompressGZIP(file_xion_zk_v1_params_proto_rawDescData)
	})
...
func init() { file_xion_zk_v1_params_proto_init() }
func file_xion_zk_v1_params_proto_init() {
	if File_xion_zk_v1_params_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_xion_zk_v1_params_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Params); i {
			case 0:
				return &v.state
			case 1:
	...
	file_xion_zk_v1_params_proto_rawDesc = nil
	file_xion_zk_v1_params_proto_goTypes = nil
	file_xion_zk_v1_params_proto_depIdxs = nil
}
