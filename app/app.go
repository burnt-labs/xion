...
import (
	...
	xion "github.com/burnt-labs/xion/x/xion"
...
type ChainApp struct {
	*baseapp.BaseApp
	...
	FeeAbsKeeper          feegrantkeeper.Keeper
...
func NewChainApp(
	...
	// Create the xion Keeper
	app.XionKeeper = xionkeeper.NewKeeper(
		appCodec,
		runtime.NewKVStoreService(keys[xiontypes.StoreKey]),
		app.BankKeeper,
		app.AccountKeeper,
		logger,
		authtypes.NewModuleAddress(govtypes.ModuleName).String(),
	...
	app.ModuleManager = module.NewManager(
		...
		xion.NewAppModule(appCodec, app.XionKeeper),
	)
