...
@kotlin.jvm.JvmName("-initializemsgDepositValidatorRewardsPool")
public inline fun msgDepositValidatorRewardsPool(block: cosmos.distribution.v1beta1.MsgDepositValidatorRewardsPoolKt.Dsl.() -> kotlin.Unit): cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool =
  cosmos.distribution.v1beta1.MsgDepositValidatorRewardsPoolKt.Dsl._create(cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool.newBuilder()).apply { block() }._build()
public object MsgDepositValidatorRewardsPoolKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool.copy(block: cosmos.distribution.v1beta1.MsgDepositValidatorRewardsPoolKt.Dsl.() -> kotlin.Unit): cosmos.distribution.v1beta1.Tx.MsgDepositValidatorRewardsPool =
  cosmos.distribution.v1beta1.MsgDepositValidatorRewardsPoolKt.Dsl._create(this.toBuilder()).apply { block() }._build()
