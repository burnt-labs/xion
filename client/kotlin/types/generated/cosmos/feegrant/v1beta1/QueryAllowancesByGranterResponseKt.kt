...
@kotlin.jvm.JvmName("-initializequeryAllowancesByGranterResponse")
public inline fun queryAllowancesByGranterResponse(block: cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponseKt.Dsl.() -> kotlin.Unit): cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse =
  cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponseKt.Dsl._create(cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse.newBuilder()).apply { block() }._build()
public object QueryAllowancesByGranterResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse.copy(block: cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponseKt.Dsl.() -> kotlin.Unit): cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponse =
  cosmos.feegrant.v1beta1.QueryAllowancesByGranterResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val cosmos.feegrant.v1beta1.QueryOuterClass.QueryAllowancesByGranterResponseOrBuilder.paginationOrNull: cosmos.base.query.v1beta1.Pagination.PageResponse?
