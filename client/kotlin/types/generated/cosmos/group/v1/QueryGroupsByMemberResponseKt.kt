...
@kotlin.jvm.JvmName("-initializequeryGroupsByMemberResponse")
public inline fun queryGroupsByMemberResponse(block: cosmos.group.v1.QueryGroupsByMemberResponseKt.Dsl.() -> kotlin.Unit): cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse =
  cosmos.group.v1.QueryGroupsByMemberResponseKt.Dsl._create(cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse.newBuilder()).apply { block() }._build()
public object QueryGroupsByMemberResponseKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse.copy(block: cosmos.group.v1.QueryGroupsByMemberResponseKt.Dsl.() -> kotlin.Unit): cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponse =
  cosmos.group.v1.QueryGroupsByMemberResponseKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val cosmos.group.v1.QueryOuterClass.QueryGroupsByMemberResponseOrBuilder.paginationOrNull: cosmos.base.query.v1beta1.Pagination.PageResponse?
