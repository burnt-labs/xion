...
@kotlin.jvm.JvmName("-initializemsgCreatePermanentLockedAccount")
public inline fun msgCreatePermanentLockedAccount(block: cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountKt.Dsl.() -> kotlin.Unit): cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount =
  cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountKt.Dsl._create(cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount.newBuilder()).apply { block() }._build()
public object MsgCreatePermanentLockedAccountKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount.copy(block: cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountKt.Dsl.() -> kotlin.Unit): cosmos.vesting.v1beta1.Tx.MsgCreatePermanentLockedAccount =
  cosmos.vesting.v1beta1.MsgCreatePermanentLockedAccountKt.Dsl._create(this.toBuilder()).apply { block() }._build()
