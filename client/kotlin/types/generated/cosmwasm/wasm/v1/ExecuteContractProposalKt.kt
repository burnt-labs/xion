...
@kotlin.jvm.JvmName("-initializeexecuteContractProposal")
public inline fun executeContractProposal(block: cosmwasm.wasm.v1.ExecuteContractProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal =
  cosmwasm.wasm.v1.ExecuteContractProposalKt.Dsl._create(cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal.newBuilder()).apply { block() }._build()
public object ExecuteContractProposalKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal.copy(block: cosmwasm.wasm.v1.ExecuteContractProposalKt.Dsl.() -> kotlin.Unit): cosmwasm.wasm.v1.ProposalLegacy.ExecuteContractProposal =
