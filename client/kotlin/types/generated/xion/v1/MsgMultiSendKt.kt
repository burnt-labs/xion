...
public inline fun msgMultiSend(block: xion.v1.MsgMultiSendKt.Dsl.() -> kotlin.Unit): xion.v1.Tx.MsgMultiSend =
  xion.v1.MsgMultiSendKt.Dsl._create(xion.v1.Tx.MsgMultiSend.newBuilder()).apply { block() }._build()
public object MsgMultiSendKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: xion.v1.Tx.MsgMultiSend.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: xion.v1.Tx.MsgMultiSend.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): xion.v1.Tx.MsgMultiSend = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun xion.v1.Tx.MsgMultiSend.copy(block: xion.v1.MsgMultiSendKt.Dsl.() -> kotlin.Unit): xion.v1.Tx.MsgMultiSend =
  xion.v1.MsgMultiSendKt.Dsl._create(this.toBuilder()).apply { block() }._build()
