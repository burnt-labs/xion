...
struct Capability_V1_Capability: Sendable {
...
struct Capability_V1_Owner: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Capability_V1_CapabilityOwners: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var owners: [Capability_V1_Owner] = []
...
extension Capability_V1_Capability: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Capability_V1_Capability, rhs: Capability_V1_Capability) -> Bool {
...
extension Capability_V1_Owner: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Capability_V1_Owner, rhs: Capability_V1_Owner) -> Bool {
...
extension Capability_V1_CapabilityOwners: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Capability_V1_CapabilityOwners, rhs: Capability_V1_CapabilityOwners) -> Bool {
