...
struct Cosmos_Auth_V1beta1_MsgUpdateParams: Sendable {
...
///
/// Since: cosmos-sdk 0.47
struct Cosmos_Auth_V1beta1_MsgUpdateParamsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Cosmos_Auth_V1beta1_MsgUpdateParams: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmos_Auth_V1beta1_MsgUpdateParams, rhs: Cosmos_Auth_V1beta1_MsgUpdateParams) -> Bool {
...
extension Cosmos_Auth_V1beta1_MsgUpdateParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Cosmos_Auth_V1beta1_MsgUpdateParamsResponse, rhs: Cosmos_Auth_V1beta1_MsgUpdateParamsResponse) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
