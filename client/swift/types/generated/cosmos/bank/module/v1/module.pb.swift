...
struct Cosmos_Bank_Module_V1_Module: Sendable {
...
fileprivate let _protobuf_package = "cosmos.bank.module.v1"

extension Cosmos_Bank_Module_V1_Module: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.blockedModuleAccountsOverride.isEmpty {
      try visitor.visitRepeatedStringField(value: self.blockedModuleAccountsOverride, fieldNumber: 1)
    }
