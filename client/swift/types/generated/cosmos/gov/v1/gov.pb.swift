...
enum Cosmos_Gov_V1_VoteOption: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Cosmos_Gov_V1_VoteOption] = [
    .unspecified,
    .yes,
    .abstain,
    .no,
...
enum Cosmos_Gov_V1_ProposalStatus: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Cosmos_Gov_V1_ProposalStatus] = [
    .unspecified,
    .depositPeriod,
    .votingPeriod,
    .passed,
...
struct Cosmos_Gov_V1_WeightedVoteOption: Sendable {
...
/// proposal.
struct Cosmos_Gov_V1_Deposit: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Gov_V1_Proposal: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Gov_V1_TallyResult: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Gov_V1_Vote: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Gov_V1_DepositParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// NOTE: This message was marked as deprecated in the .proto file.
struct Cosmos_Gov_V1_VotingParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
///
/// NOTE: This message was marked as deprecated in the .proto file.
struct Cosmos_Gov_V1_TallyParams: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
