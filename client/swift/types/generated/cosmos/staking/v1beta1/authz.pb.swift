...
enum Cosmos_Staking_V1beta1_AuthorizationType: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Cosmos_Staking_V1beta1_AuthorizationType] = [
    .unspecified,
    .delegate,
    .undelegate,
    .redelegate,
...
///
/// Since: cosmos-sdk 0.43
struct Cosmos_Staking_V1beta1_StakeAuthorization: Sendable {
  ...
  /// validators is the oneof that represents either allow_list or deny_list
  enum OneOf_Validators: Equatable, Sendable {
    /// allow_list specifies list of validator addresses to whom grantee can delegate tokens on behalf of granter's
    /// account.
