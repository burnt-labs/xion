...
enum Cosmos_Tx_V1beta1_OrderBy: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Cosmos_Tx_V1beta1_OrderBy] = [
    .unspecified,
    .asc,
    .desc,
  ]
...
/// method.
enum Cosmos_Tx_V1beta1_BroadcastMode: SwiftProtobuf.Enum, Swift.CaseIterable {
  typealias RawValue = Int
  ...
  // The compiler won't synthesize support with the UNRECOGNIZED case.
  static let allCases: [Cosmos_Tx_V1beta1_BroadcastMode] = [
    .unspecified,
    .block,
    .sync,
    .async,
...
/// RPC method.
struct Cosmos_Tx_V1beta1_GetTxsEventRequest: Sendable {
...
/// RPC method.
struct Cosmos_Tx_V1beta1_GetTxsEventResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// RPC method.
struct Cosmos_Tx_V1beta1_BroadcastTxRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Tx_V1beta1_BroadcastTxResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// RPC method.
struct Cosmos_Tx_V1beta1_SimulateRequest: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Tx_V1beta1_SimulateResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
/// RPC method.
struct Cosmos_Tx_V1beta1_GetTxRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Cosmos_Tx_V1beta1_GetTxResponse: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
