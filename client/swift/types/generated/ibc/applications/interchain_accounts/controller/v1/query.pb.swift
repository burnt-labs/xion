...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest: Sendable {
...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsRequest: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsResponse: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest, rhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountRequest) -> Bool {
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse, rhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryInterchainAccountResponse) -> Bool {
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsRequest: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsRequest, rhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsRequest) -> Bool {
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}
...
extension Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsResponse: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsResponse, rhs: Ibc_Applications_InterchainAccounts_Controller_V1_QueryParamsResponse) -> Bool {
