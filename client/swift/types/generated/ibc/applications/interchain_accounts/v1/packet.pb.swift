...
/// host
enum Ibc_Applications_InterchainAccounts_V1_Type: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Ibc_Applications_InterchainAccounts_V1_Type] = [
    .unspecified,
    .executeTx,
  ]
...
struct Ibc_Applications_InterchainAccounts_V1_InterchainAccountPacketData: @unchecked Sendable {
...
struct Ibc_Applications_InterchainAccounts_V1_CosmosTx: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
