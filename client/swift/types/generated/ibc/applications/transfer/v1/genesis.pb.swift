...
struct Ibc_Applications_Transfer_V1_GenesisState: Sendable {
  ...
  var totalEscrowed: [Cosmos_Base_V1beta1_Coin] = []
...
extension Ibc_Applications_Transfer_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.totalEscrowed.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.totalEscrowed, fieldNumber: 4)
    }
