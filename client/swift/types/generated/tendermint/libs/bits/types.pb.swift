...
struct Tendermint_Libs_Bits_BitArray: Sendable {
...
extension Tendermint_Libs_Bits_BitArray: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularInt64Field(value: &self.bits) }()
      case 2: try { try decoder.decodeRepeatedUInt64Field(value: &self.elems) }()
      default: break
      }
    }
  }
