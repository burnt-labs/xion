...
enum Tendermint_Types_BlockIDFlag: SwiftProtobuf.Enum, Swift.CaseIterable {
  ...
  static let allCases: [Tendermint_Types_BlockIDFlag] = [
    .unknown,
    .absent,
    .commit,
    .nil,
...
struct Tendermint_Types_ValidatorSet: Sendable {
...
struct Tendermint_Types_Validator: @unchecked Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
struct Tendermint_Types_SimpleValidator: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
