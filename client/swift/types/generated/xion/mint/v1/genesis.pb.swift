...
struct Xion_Mint_V1_GenesisState: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  /// minter is a space for holding current inflation information.
  var minter: Xion_Mint_V1_Minter {
    get {return _minter ?? Xion_Mint_V1_Minter()}
  ...
  fileprivate var _minter: Xion_Mint_V1_Minter? = nil
...
extension Xion_Mint_V1_GenesisState: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static func ==(lhs: Xion_Mint_V1_GenesisState, rhs: Xion_Mint_V1_GenesisState) -> Bool {
