...
// source: xion/indexer/authz/v1/authz_query.proto
...
func (*QueryGrantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c9469af8b4dcc1, []int{0}
}
...
func (*QueryGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c9469af8b4dcc1, []int{1}
}
...
func (*QueryGranterGrantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c9469af8b4dcc1, []int{2}
}
...
func (*QueryGranterGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c9469af8b4dcc1, []int{3}
}
...
func (*QueryGranteeGrantsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c9469af8b4dcc1, []int{4}
}
...
func (*QueryGranteeGrantsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_92c9469af8b4dcc1, []int{5}
}
...
func init() {
	proto.RegisterFile("xion/indexer/authz/v1/authz_query.proto", fileDescriptor_92c9469af8b4dcc1)
}

var fileDescriptor_92c9469af8b4dcc1 = []byte{
	// 551 bytes of a gzipped FileDescriptorProto
	,
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Metadata: "xion/indexer/authz/v1/authz_query.proto",
}
...
func (m *QueryGrantsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.Pagination != nil {
		{
			...
			i -= size
			i = encodeVarintAuthzQuery(dAtA, i, uint64(size))
		}
		i--
		dAtA[i] = 0x22
	}
	if len(m.MsgTypeUrl) > 0 {
		...
		i = encodeVarintAuthzQuery(dAtA, i, uint64(len(m.MsgTypeUrl)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Grantee) > 0 {
		...
		i = encodeVarintAuthzQuery(dAtA, i, uint64(len(m.Grantee)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Granter) > 0 {
		...
		i = encodeVarintAuthzQuery(dAtA, i, uint64(len(m.Granter)))
		i--
		dAtA[i] = 0xa
	}
...
func encodeVarintAuthzQuery(dAtA []byte, offset int, v uint64) int {
	offset -= sovAuthzQuery(v)
	base := offset
	for v >= 1<<7 {
...
func sovAuthzQuery(x uint64) (n int) {
	return (math_bits.Len64(x|1) + 6) / 7
}
func sozAuthzQuery(x uint64) (n int) {
	return sovAuthzQuery(uint64((x << 1) ^ uint64((int64(x) >> 63))))
}
func (m *QueryGrantsRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return ErrIntOverflowAuthzQuery
			}
			if iNdEx >= l {
		...
		case 1:
			...
			if intStringLen < 0 {
				return ErrInvalidLengthAuthzQuery
			}
		...
		default:
			iNdEx = preIndex
			skippy, err := skipAuthzQuery(dAtA[iNdEx:])
			if err != nil {
				return err
			}
...
func skipAuthzQuery(dAtA []byte) (n int, err error) {
	l := len(dAtA)
	iNdEx := 0
	depth := 0
	for iNdEx < l {
		...
		for shift := uint(0); ; shift += 7 {
			if shift >= 64 {
				return 0, ErrIntOverflowAuthzQuery
			}
			if iNdEx >= l {
		...
		case 2:
			...
			if length < 0 {
				return 0, ErrInvalidLengthAuthzQuery
			}
			iNdEx += length
		case 3:
			depth++
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupAuthzQuery
			}
			depth--
		case 5:
			iNdEx += 4
...
var (
	ErrInvalidLengthAuthzQuery        = fmt.Errorf("proto: negative length found during unmarshaling")
	ErrIntOverflowAuthzQuery          = fmt.Errorf("proto: integer overflow")
	ErrUnexpectedEndOfGroupAuthzQuery = fmt.Errorf("proto: unexpected end of group")
)
