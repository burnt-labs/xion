...
//	users := ibctest.GetAndFundTestUsers(t, ctx, "default", math.NewInt(fundAmount), xion, osmosis)
//	xionUser := users[0]
//	osmosisUser := users[1]
...
//		proposalInfo, err := xion.GovQueryProposal(ctx, paramChangeTx.ProposalID)
//		if err != nil {
//			require.NoError(t, err)
//		} else {
//			if proposalInfo.Status == v1beta1.StatusVotingPeriod {
//				return true
//			}
...
//
//	emptyUserBals, err := xion.BankQueryAllBalances(ctx, emptyKeyAddress)
//	require.NoError(t, err)
...
//		return err == nil && math.NewInt(1_000_000) == xionUserOsmoBal
