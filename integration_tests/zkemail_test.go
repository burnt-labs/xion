...
func TestZKEmailAuthenticator(t *testing.T) {
	...
	// NOTE: must rework
	xion := BuildXionChain(t, "0.0uxion", ModifyInterChainGenesis(ModifyInterChainGenesisFn{ModifyGenesisShortProposals, ModifyGenesisDKIMRecords, ModifyGenesisAAParams}, [][]string{{votingPeriod, maxDepositPeriod}, {string(gPubKeyBz)}, {"20000000"}}))
