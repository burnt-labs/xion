...
# CHAIN_ID="local-2" HOME_DIR="~/.simapp" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export BINARY=${BINARY:-xiond}
export DENOM=${DENOM:-uxion}
...
from_scratch () {
  ...
  # xion1efd63aw40lxf3n4mhf7dzhjkr453axurc3m5np
  ...
  # xion1hj5fveer5cjtn4wd6wstzugjfdxzl0xpy9gs6g
  ...
  # === CUSTOM MODULES ===
  # globalfee
  update_test_genesis `printf '.app_state["globalfee"]["params"]["minimum_gas_prices"]=[{"amount":"0.002500000000000000","denom":"%s"}]' $DENOM`
  # tokenfactory
