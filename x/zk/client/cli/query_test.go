...
func TestGetQueryCmd(t *testing.T) {
	...
	t.Run("has expected subcommands", func(t *testing.T) {
		...
		require.True(t, names["verify-gnark [proof-file]"])
...
// ============================================================================
// GetCmdQueryVerifyGnark Tests
// ============================================================================

func TestGetCmdQueryVerifyGnark(t *testing.T) {
	t.Run("returns valid command", func(t *testing.T) {
		cmd := cli.GetCmdQueryVerifyGnark()
		require.NotNil(t, cmd)
		require.Equal(t, "verify-gnark [proof-file]", cmd.Use)
		require.Contains(t, cmd.Short, "gnark")
		require.Contains(t, cmd.Short, "Groth16")
	})
	...
	t.Run("has vkey-name flag", func(t *testing.T) {
		...
		f := cmd.Flags().Lookup("vkey-name")
		require.NotNil(t, f)
		require.Contains(t, f.Usage, "gnark")
	})
	...
	t.Run("has long description", func(t *testing.T) {
		cmd := cli.GetCmdQueryVerifyGnark()
		require.NotEmpty(t, cmd.Long)
		require.Contains(t, cmd.Long, "gnark")
		require.Contains(t, cmd.Long, "--public-inputs-file")
	})
	...
	t.Run("has example usage", func(t *testing.T) {
		...
		require.NotEmpty(t, cmd.Example)
		require.Contains(t, cmd.Example, "proof.bin")
		require.Contains(t, cmd.Example, "verify-gnark")
	})
}

func TestGetCmdQueryVerifyGnarkExtended(t *testing.T) {
	t.Run("RunE fails with non-existent proof file", func(t *testing.T) {
		cmd := cli.GetCmdQueryVerifyGnark()
		require.NoError(t, cmd.Flags().Set("vkey-name", "test"))
		require.NoError(t, cmd.Flags().Set("public-inputs-file", "/tmp/inputs.bin"))
