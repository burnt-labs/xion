...
func TestValidateVKeyBytes(t *testing.T) {
	t.Run("valid vkey bytes", func(t *testing.T) {
		err := types.ValidateVKeyBytes(validVKeyJSON)
	...
	t.Run("invalid JSON", func(t *testing.T) {
		err := types.ValidateVKeyBytes([]byte("not valid json"))
		require.Error(t, err)
	...
	t.Run("unsupported protocol", func(t *testing.T) {
		...
		err := types.ValidateVKeyBytes(data)
		require.Error(t, err)
...
func TestNewVKeyFromBytes(t *testing.T) {
	t.Run("valid bytes", func(t *testing.T) {
		vkey, err := types.NewVKeyFromBytes(validVKeyJSON, "test-vkey", "test description")
		require.NoError(t, err)
	...
	t.Run("empty name is allowed", func(t *testing.T) {
		vkey, err := types.NewVKeyFromBytes(validVKeyJSON, "", "test description")
		require.NoError(t, err)
		require.NotNil(t, vkey)
	...
	t.Run("empty description is allowed", func(t *testing.T) {
		vkey, err := types.NewVKeyFromBytes(validVKeyJSON, "test-vkey", "")
		require.NoError(t, err)
		require.NotNil(t, vkey)
